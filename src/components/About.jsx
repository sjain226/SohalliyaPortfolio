...
const About = () => {
  return (
    <div className="pb-32 px-6 lg:px-16 bg-gradient-to-r from-pink-100 via-purple-100 to-pink-100">
      {/* Section Title */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          ...
          <motion.div 
            ...
            className="flex flex-col items-center justify-center bg-white shadow-lg rounded-2xl p-6 border-4 border-pink-300"
          >
          ...
          <motion.div 
            ...
            initial={{ opacity: 0, x: -100 }} 
            transition={{ duration: 0.5 }} 
            className="flex flex-col items-center justify-center bg-white shadow-lg rounded-2xl p-6 border-4 border-purple-300"
          >
        ...
        <div className="space-y-8">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.5 }} 
            className="bg-white shadow-lg rounded-2xl p-6 border-4 border-pink-300"
          >
